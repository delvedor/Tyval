    ...
    validators.forEach((validator) => {
      ...
      for (let val in params) {
        ...
        // If the variable is an object (but not an instance of RegExp) we stringify it
          ...
          code += `let ${val} = ${JSON.stringify(params[val])};\n`
      ...
      let functionCode = validator.function.toString()
      ...
      code += functionCode.substring(functionCode.indexOf('{') + 1) + ';\n'
    })
