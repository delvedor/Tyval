...
test('error', (t) => {
  ...
  let err = tyval.error().toFunction()
...
test('error.RangeError', (t) => {
  ...
  let err = tyval.error().RangeError().toFunction()
  t.is(typeof err, 'function')
...
test('error.ReferenceError', (t) => {
  ...
  let err = tyval.error().ReferenceError().toFunction()
  t.is(typeof err, 'function')
...
test('error.SyntaxError', (t) => {
  ...
  let err = tyval.error().SyntaxError().toFunction()
  t.is(typeof err, 'function')
...
test('error.TypeError', (t) => {
  ...
  let err = tyval.error().TypeError().toFunction()
  t.is(typeof err, 'function')
...
test('error.message', (t) => {
  ...
  let err = tyval.error().message('some error').toFunction()
  t.is(typeof err, 'function')
